...
// import ChatModalBox from "../components/Chat"
          ...
          <div className="profile__container row">
            ...
            <div className="user__container col-md-4 p-3">
              <div className="user__info__container">
                ...
                <button onClick={showChat} className="btn__chat">Chat</button>
              </div>
            </div>
            {/* navigation anchor */}
            <div className="showcase col-md-8 p-3">
              <div className="buttons">
                <a onClick={hideItems} className="btn">show case</a>
                <a onClick={itemsShow} className="btn">items</a>
                <a onClick={showModalWishlist} className="btn">wishlist</a>
